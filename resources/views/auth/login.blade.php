                ...
                <div class="row g-5">
                        <div class="login-form-box">
                            ...
                            <form method="POST" action="{{ route('api.send.otp') }}" data-otp-url="{{ route('login.otp') }}" class="login ajx-sendotp-form" autocomplete="off">
                                ...
                                <!-- <div class="mb--30">
                                    <span><h6>Select any one to receive an OTP message.</h6></span>
                                </div> -->
                                <!-- <div class="form-check form-check-inline mb--30">
                                  <input class="form-check-input" type="radio" name="otp_message" id="sms" value="sms">
                                  <label class="form-check-label" for="sms">SMS</label>
                                </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="form-check form-check-inline mb--30">
                                  <input class="form-check-input" type="radio" name="otp_message" id="whatsapp" value="whatsapp">
